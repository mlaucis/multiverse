...
logger -t ${INSTALLER_COMPONENT}_installer installing certificate
...
BmNddyWm
-----END CERTIFICATE-----' > ~/ssl/self.crt

logger -t ${INSTALLER_COMPONENT}_installer installing private key
...
-----END RSA PRIVATE KEY-----' > ~/ssl/self.key

logger -t ${INSTALLER_COMPONENT}_installer installing cloudflare certificate
echo '-----BEGIN CERTIFICATE-----
