...
func (e *event) addEventGeo(key string, updatedEvent *entity.Event) errors.Error {
	coordinates := georedis.GeoKey{
...
func (e *event) removeEventGeo(key string, updatedEvent *entity.Event) errors.Error {
	geoEventKey := storageHelper.EventGeoKey(updatedEvent.AccountID, updatedEvent.ApplicationID)
...
func (e *event) addEventObject(key string, updatedEvent *entity.Event) errors.Error {
...
func (e *event) removeEventObject(key string, updatedEvent *entity.Event) errors.Error {
	objectEventKey := storageHelper.EventObjectKey(updatedEvent.AccountID, updatedEvent.ApplicationID, updatedEvent.Object.ID)
...
func (e *event) addEventLocation(key string, updatedEvent *entity.Event) errors.Error {
...
func (e *event) removeEventLocation(key string, updatedEvent *entity.Event) errors.Error {
	locationEventKey := storageHelper.EventLocationKey(updatedEvent.AccountID, updatedEvent.ApplicationID, updatedEvent.Location)
