...
func ContextHasAccount(ctx *context.Context) (err tgerrors.TGError) {
	ctx.Bag["account"], err = acc.Read(ctx.Bag["accountID"].(int64))
	return
}
...
func ContextHasAccountUser(ctx *context.Context) (err tgerrors.TGError) {
	ctx.Bag["accountUser"], err = accUser.Read(ctx.Bag["accountID"].(int64), ctx.Bag["accountUserID"].(int64))
	return
}
...
func ContextHasApplication(ctx *context.Context) (err tgerrors.TGError) {
	ctx.Bag["application"], err = app.Read(ctx.Bag["accountID"].(int64), ctx.Bag["applicationID"].(int64))
	return
}
...
func ContextHasApplicationUser(ctx *context.Context) (err tgerrors.TGError) {
	ctx.Bag["applicationUser"], err = appUser.Read(ctx.Bag["accountID"].(int64), ctx.Bag["applicationID"].(int64), ctx.Bag["applicationUserID"].(int64))
	return
}
