...
logger -t intaker_installer got INSTALLER_CAHNNEL: ${INSTALLER_CHANNEL}
...
logger -t intaker_installer installing certificate
...
logger -t intaker_installer installing private key
...
logger -t intaker_installer installing cloudflare certificate
echo '-----BEGIN CERTIFICATE-----
