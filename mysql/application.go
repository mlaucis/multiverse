...
func GetAccountAllApplications(accountID int64) (applications []*entity.Application, err error) {
...
func AddAccountApplication(accountID int64, application *entity.Application) (*entity.Application, error) {
	// Check if key empty
	...
	result, err := GetMaster().Exec(query, accountID, application.AuthToken, application.Name)
	if err != nil {
