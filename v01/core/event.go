...
func ReadEvent(accountID, applicationID, userID, eventID int64) (event *entity.Event, err errors.Error) {
...
func UpdateEvent(existingEvent, updatedEvent entity.Event, retrieve bool) (evn *entity.Event, err errors.Error) {
...
func DeleteEvent(accountID, applicationID, userID, eventID int64) (err errors.Error) {
	key := storageClient.Event(accountID, applicationID, userID, eventID)
...
func ReadEventList(accountID, applicationID, userID int64) (events []*entity.Event, err errors.Error) {
...
func ReadConnectionEventList(accountID, applicationID, userID int64) (events []*entity.Event, err errors.Error) {
...
func WriteEvent(event *entity.Event, retrieve bool) (evn *entity.Event, err errors.Error) {
	event.Enabled = true
...
func WriteEventToConnectionsLists(event *entity.Event, key string) (err errors.Error) {
...
func DeleteEventFromConnectionsLists(accountID, applicationID, userID int64, key string) (err errors.Error) {
...
func SearchGeoEvents(accountID, applicationID int64, latitude, longitude, radius float64) (events []*entity.Event, err errors.Error) {
...
func SearchObjectEvents(accountID, applicationID int64, objectKey string) ([]*entity.Event, errors.Error) {
...
func SearchLocationEvents(accountID, applicationID int64, locationKey string) ([]*entity.Event, errors.Error) {
...
func fetchEventsFromKeys(accountID, applicationID int64, bucketName string) ([]*entity.Event, errors.Error) {
...
func toEvents(resultList []interface{}) ([]*entity.Event, errors.Error) {
	events := []*entity.Event{}
...
func addEventGeo(key string, updatedEvent *entity.Event) errors.Error {
	coordinates := georedis.GeoKey{
...
func removeEventGeo(key string, updatedEvent *entity.Event) errors.Error {
	geoEventKey := storageClient.EventGeoKey(updatedEvent.AccountID, updatedEvent.ApplicationID)
...
func addEventObject(key string, updatedEvent *entity.Event) errors.Error {
...
func removeEventObject(key string, updatedEvent *entity.Event) errors.Error {
	objectEventKey := storageClient.EventObjectKey(updatedEvent.AccountID, updatedEvent.ApplicationID, updatedEvent.Object.ID)
...
func addEventLocation(key string, updatedEvent *entity.Event) errors.Error {
...
func removeEventLocation(key string, updatedEvent *entity.Event) errors.Error {
	locationEventKey := storageClient.EventLocationKey(updatedEvent.AccountID, updatedEvent.ApplicationID, updatedEvent.Location)
