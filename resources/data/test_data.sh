...
curl -i -H "Content-Type: application/json" -d '{"auth_token": "yZg6ZCJjHGy5caTcVnD25pVMEswUEQWTSA64tkBU", "user_name": "dlsniper", "first_name": "Florin", "last_name": "Patan", "password": "JjQxWYYCWfX634q6KQeDSusywVH3T5Dw9hMqBcUd", "email": "florinpatan@gmail.com", "url": "http://florinpatan.ro", "metadata": "{}"}' localhost:8082/0.1/application/1/users
curl -i -H "Content-Type: application/json" -d '{"auth_token": "yZg6ZCJjHGy5caTcVnD25pVMEswUEQWTSA64tkBU", "user_name": "dlsniper", "first_name": "Florin", "last_name": "Patan", "password": "JjQxWYYCWfX634q6KQeDSusywVH3T5Dw9hMqBcUd", "email": "florinpatan@gmail.com", "url": "http://florinpatan.ro", "metadata": "{}"}' localhost:8082/0.1/application/1/users
curl -i -H "Content-Type: application/json" -d '{"user_from_id":1,"user_to_id":2}' localhost:8082/0.1/application/1/connections
curl -i -H "Content-Type: application/json" -d '{"user_from_id":1,"user_to_id":3}' localhost:8082/0.1/application/1/connections
curl -i -H "Content-Type: application/json" -d '{"user_from_id":1,"user_to_id":5}' localhost:8082/0.1/application/1/connections
curl -i -H "Content-Type: application/json" -d '{"user_from_id":2,"user_to_id":5}' localhost:8082/0.1/application/1/connections
curl -i -H "Content-Type: application/json" -d '{"user_from_id":2,"user_to_id":3}' localhost:8082/0.1/application/1/connections
curl -i -H "Content-Type: application/json" -d '{"user_from_id":3,"user_to_id":5}' localhost:8082/0.1/application/1/connections
curl -i -H "Content-Type: application/json" -d '{"user_from_id":4,"user_to_id":5}' localhost:8082/0.1/application/1/connections
